...
export default function Ourpartners() {
  return (
    ...
    <div className="flex flex-col justify-center items-center text-start py-[3%]">
        <h1 className='text-blue-600 text-sm font-normal flex uppercase'>
            Our Partners    
        </h1>
        <h1 className="text-blue-600 text-2xl font-bold flex justify-center uppercase ">We work with the best partners</h1>
